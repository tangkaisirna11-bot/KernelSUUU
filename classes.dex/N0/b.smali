...
.method public static final a(Ln0/c;Ln0/F;)V
    .registers 9

    iget-object v0, p1, Ln0/F;->m:Ljava/util/List;
    ...
    iget-object v2, p1, Ln0/F;->m:Ljava/util/List;
    ...
    iget-object v5, v2, Ln0/J;->e:Ljava/lang/Object;

    iput-object v5, v3, Ln0/h;->d:Ljava/lang/Object;

    iput-boolean v4, v3, Ln0/h;->n:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget-object v5, v3, Ln0/h;->s:Lh0/i;

    iget v6, v2, Ln0/J;->f:I

    invoke-virtual {v5, v6}, Lh0/i;->g(I)V

    invoke-virtual {v3}, Ln0/C;->c()V

    invoke-virtual {v3}, Ln0/C;->c()V

    iget-object v5, v2, Ln0/J;->g:Lh0/o;

    iput-object v5, v3, Ln0/h;->b:Lh0/o;

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->h:F

    iput v5, v3, Ln0/h;->c:F

    invoke-virtual {v3}, Ln0/C;->c()V

    iget-object v5, v2, Ln0/J;->i:Lh0/o;

    iput-object v5, v3, Ln0/h;->g:Lh0/o;

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->j:F

    iput v5, v3, Ln0/h;->e:F

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->k:F

    iput v5, v3, Ln0/h;->f:F

    iput-boolean v4, v3, Ln0/h;->o:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->l:I

    iput v5, v3, Ln0/h;->h:I

    iput-boolean v4, v3, Ln0/h;->o:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->m:I

    iput v5, v3, Ln0/h;->i:I

    iput-boolean v4, v3, Ln0/h;->o:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->n:F

    iput v5, v3, Ln0/h;->j:F

    iput-boolean v4, v3, Ln0/h;->o:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->o:F

    iput v5, v3, Ln0/h;->k:F

    iput-boolean v4, v3, Ln0/h;->p:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/J;->p:F

    iput v5, v3, Ln0/h;->l:F

    iput-boolean v4, v3, Ln0/h;->p:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v2, v2, Ln0/J;->q:F

    iput v2, v3, Ln0/h;->m:F

    iput-boolean v4, v3, Ln0/h;->p:Z

    invoke-virtual {v3}, Ln0/C;->c()V

    invoke-virtual {p0, v1, v3}, Ln0/c;->e(ILn0/C;)V
    ...
    iget-object v5, v2, Ln0/F;->d:Ljava/lang/String;

    iput-object v5, v3, Ln0/c;->k:Ljava/lang/String;

    invoke-virtual {v3}, Ln0/C;->c()V

    iget v5, v2, Ln0/F;->e:F
    ...
    iget-object v5, v2, Ln0/F;->l:Ljava/util/List;
    ...
    invoke-static {v3, v2}, Ln0/b;->a(Ln0/c;Ln0/F;)V
...
.method public static final b(Lh0/H;DDDDDDDZZ)V
    .registers 68
    ...
    invoke-static/range {v0 .. v16}, Ln0/b;->b(Lh0/H;DDDDDDDZZ)V
    ...
    iget-object v14, v14, Lh0/i;->a:Landroid/graphics/Path;
...
.method public static final c(Ln0/f;LO/p;)Ln0/I;
    .registers 14
    ...
    invoke-virtual {p1, v1, v2}, LO/p;->e(J)Z
    ...
    invoke-static {v1, v2}, Ln0/b;->a(Ln0/c;Ln0/F;)V
    ...
    invoke-interface {v0, v3}, LU0/b;->Q(F)F
    ...
    :cond_63
    invoke-static {v0, v4}, LX/c;->n(FF)J

    move-result-wide v4

    new-instance v0, Ln0/I;

    invoke-direct {v0, v1}, Ln0/I;-><init>(Ln0/c;)V

    const-wide/16 v6, 0x10

    iget-wide v8, p0, Ln0/f;->g:J
    ...
    iget v10, p0, Ln0/f;->h:I

    if-lt v6, v7, :cond_85

    sget-object v6, Lh0/m;->a:Lh0/m;

    invoke-virtual {v6, v8, v9, v10}, Lh0/m;->a(JI)Landroid/graphics/BlendModeColorFilter;
    ...
    invoke-static {v10}, Lh0/I;->H(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_92
    invoke-direct {v1, v8, v9, v10, v6}, Lh0/l;-><init>(JILandroid/graphics/ColorFilter;)V
    ...
    invoke-direct {v6, v2, v3}, Lg0/f;-><init>(J)V

    iget-object v2, v0, Ln0/I;->h:LO/h0;
    ...
    iget-object v3, v0, Ln0/I;->i:LO/h0;

    invoke-virtual {v3, v2}, LO/h0;->setValue(Ljava/lang/Object;)V

    iget-object v2, v0, Ln0/I;->j:Ln0/E;

    iget-object v3, v2, Ln0/E;->g:LO/h0;

    invoke-virtual {v3, v1}, LO/h0;->setValue(Ljava/lang/Object;)V

    new-instance v1, Lg0/f;

    invoke-direct {v1, v4, v5}, Lg0/f;-><init>(J)V

    iget-object v3, v2, Ln0/E;->i:LO/h0;

    invoke-virtual {v3, v1}, LO/h0;->setValue(Ljava/lang/Object;)V

    iget-object p0, p0, Ln0/f;->a:Ljava/lang/String;

    iput-object p0, v2, Ln0/E;->c:Ljava/lang/String;
...
.method public static final d(Ljava/util/List;Lh0/H;)V
    .registers 33
    ...
    iget-object v1, v14, Lh0/i;->a:Landroid/graphics/Path;
    ...
    :goto_14
    iget-object v2, v14, Lh0/i;->a:Landroid/graphics/Path;

    invoke-virtual {v2}, Landroid/graphics/Path;->rewind()V

    invoke-virtual {v14, v1}, Lh0/i;->g(I)V
    ...
    instance-of v6, v10, Ln0/j;

    iget-object v7, v14, Lh0/i;->a:Landroid/graphics/Path;
    ...
    iget v6, v1, Ln0/v;->c:F

    add-float/2addr v2, v6

    iget v1, v1, Ln0/v;->d:F
    ...
    iget v2, v1, Ln0/n;->c:F

    iget v1, v1, Ln0/n;->d:F
    ...
    iget v6, v1, Ln0/u;->c:F

    iget v8, v1, Ln0/u;->d:F

    invoke-virtual {v7, v6, v8}, Landroid/graphics/Path;->rLineTo(FF)V

    iget v1, v1, Ln0/u;->c:F
    ...
    iget v2, v1, Ln0/m;->c:F

    iget v3, v1, Ln0/m;->d:F

    invoke-virtual {v14, v2, v3}, Lh0/i;->d(FF)V

    iget v1, v1, Ln0/m;->c:F
    ...
    iget v2, v1, Ln0/l;->c:F

    invoke-virtual {v14, v2, v3}, Lh0/i;->d(FF)V

    iget v1, v1, Ln0/l;->c:F

    goto :goto_b4

    :cond_d5
    instance-of v6, v10, Ln0/z;
    ...
    iget v3, v1, Ln0/A;->c:F

    invoke-virtual {v14, v2, v3}, Lh0/i;->d(FF)V

    iget v1, v1, Ln0/A;->c:F
    ...
    iget v4, v1, Ln0/s;->c:F

    iget v5, v1, Ln0/s;->d:F

    iget v6, v1, Ln0/s;->e:F

    iget v8, v1, Ln0/s;->f:F

    iget v9, v1, Ln0/s;->g:F

    iget v11, v1, Ln0/s;->h:F
    ...
    iget v4, v1, Ln0/s;->e:F

    add-float/2addr v4, v2

    iget v5, v1, Ln0/s;->f:F

    add-float/2addr v5, v3

    iget v6, v1, Ln0/s;->g:F

    add-float/2addr v2, v6

    iget v1, v1, Ln0/s;->h:F

    goto :goto_e3

    :cond_126
    instance-of v6, v10, Ln0/k;
    ...
    iget v2, v1, Ln0/k;->c:F

    iget v3, v1, Ln0/k;->d:F

    iget v4, v1, Ln0/k;->e:F

    iget v5, v1, Ln0/k;->f:F

    iget v6, v1, Ln0/k;->g:F

    iget v8, v1, Ln0/k;->h:F
    ...
    iget v2, v1, Ln0/k;->e:F

    iget v3, v1, Ln0/k;->f:F

    iget v4, v1, Ln0/k;->g:F

    iget v1, v1, Ln0/k;->h:F
    ...
    :cond_165
    instance-of v6, v10, Ln0/x;

    if-eqz v6, :cond_19f

    iget-boolean v1, v1, Ln0/B;->a:Z
    ...
    iget v4, v1, Ln0/x;->c:F

    iget v5, v1, Ln0/x;->d:F

    iget v6, v1, Ln0/x;->e:F

    iget v8, v1, Ln0/x;->f:F
    ...
    iget v1, v1, Ln0/x;->f:F

    goto/16 :goto_e3

    :cond_19f
    instance-of v6, v10, Ln0/p;
    ...
    iget v2, v1, Ln0/p;->c:F

    iget v3, v1, Ln0/p;->d:F

    iget v4, v1, Ln0/p;->e:F

    iget v5, v1, Ln0/p;->f:F
    ...
    iget v1, v1, Ln0/p;->f:F

    goto/16 :goto_152

    :cond_1d4
    instance-of v6, v10, Ln0/w;
    ...
    iget v4, v1, Ln0/w;->c:F

    iget v5, v1, Ln0/w;->d:F

    iget v6, v1, Ln0/w;->e:F

    iget v8, v1, Ln0/w;->f:F

    invoke-virtual {v7, v4, v5, v6, v8}, Landroid/graphics/Path;->rQuadTo(FFFF)V

    iget v1, v1, Ln0/w;->c:F
    ...
    :cond_216
    instance-of v6, v10, Ln0/y;

    if-eqz v6, :cond_243

    iget-boolean v1, v1, Ln0/B;->b:Z
    ...
    iget v6, v5, Ln0/y;->c:F

    iget v8, v5, Ln0/y;->d:F
    ...
    iget v4, v1, Ln0/q;->c:F

    iget v5, v1, Ln0/q;->d:F

    invoke-virtual {v7, v2, v3, v4, v5}, Landroid/graphics/Path;->quadTo(FFFF)V

    iget v1, v1, Ln0/q;->c:F
    ...
    iget v4, v1, Ln0/r;->h:F

    add-float v11, v4, v2

    iget v4, v1, Ln0/r;->i:F
    ...
    iget v9, v1, Ln0/r;->d:F

    move-wide/from16 v23, v10

    float-to-double v10, v9

    iget v9, v1, Ln0/r;->e:F

    move-wide/from16 v25, v10

    float-to-double v10, v9

    iget-boolean v9, v1, Ln0/r;->f:Z

    move/from16 v16, v9

    iget-boolean v1, v1, Ln0/r;->g:Z
    ...
    invoke-static/range {v1 .. v17}, Ln0/b;->b(Lh0/H;DDDDDDDZZ)V
    ...
    iget v1, v14, Ln0/i;->h:F

    float-to-double v8, v1

    iget v15, v14, Ln0/i;->i:F

    float-to-double v10, v15

    iget v1, v14, Ln0/i;->c:F

    float-to-double v12, v1

    iget v1, v14, Ln0/i;->d:F

    float-to-double v2, v1

    iget v1, v14, Ln0/i;->e:F

    move-wide/from16 v25, v12

    float-to-double v12, v1

    iget-boolean v1, v14, Ln0/i;->f:Z

    move/from16 v16, v1

    iget-boolean v1, v14, Ln0/i;->g:Z
